...
{
    public class UpdateEmailTypeCommandHandler : ICommandHandler<UpdateEmailTypeCommand, UpdateEmailTypeResult>
    {
        private readonly IEmailTypeRepository _repository;
        private readonly IUnitOfWork _unitOfWork;

        public UpdateEmailTypeCommandHandler(IEmailTypeRepository repository, IUnitOfWork unitOfWork)
        {
            _repository = repository ?? throw new ArgumentNullException(nameof(repository));
            _unitOfWork = unitOfWork ?? throw new ArgumentNullException(nameof(unitOfWork));
        }

        public async Task<UpdateEmailTypeResult> Handle(UpdateEmailTypeCommand command, CancellationToken cancellationToken)
        {
            ...
            if (entity == null)
                throw new InvalidOperationException($"EmailType with ID {command.Id} not found");
            ...
            return new UpdateEmailTypeResult(entity.Id, entity.Name, entity.Description, entity.IsActive);
        }
